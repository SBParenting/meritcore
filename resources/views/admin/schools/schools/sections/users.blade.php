		...
		@foreach($records as $record)
			...
			<tr id="record-{{ $record->id }}">
				...
				<td>
					...
					<a href="{{ url("/admin/s/schools/remove-user/$record->id") }}" class="btn btn-xs btn-default do-tooltip js-post-remove" title="Remove this user." data-remove="#record-{{ $record->id }}"><i class="fa fa-times"></i></a>
				</td>
			</tr>
