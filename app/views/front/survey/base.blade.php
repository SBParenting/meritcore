                    ...
                    <div class="bar-container">
                        ...
                        <div class="progress ng-isolate-scope progress-bar-container" max="max" value="dynamic">
                            ...
                            <div class="progress-bar progress-blue" ng-class="type &amp;&amp; 'progress-bar-' + type"
                                 ...
                                 style="width: 10%;"><span class="ng-binding ng-scope">10/10</span></div>
                    ...
                    <div class="container">
                        <table>
                            <tr>
                                ...
                                <td class="list-item" id="not-at-all"><a>strongly<br/>disagree</a></td>
                                <td class="list-item" id="not-so-much"><a>disagree</a></td>
                                <td class="list-item" id="not-sure"><a>not sure</a></td>
                                <td class="list-item" id="somewhat-concern"><a>agree</a></td>
                                <td class="list-item" id="major-concern"><a>strongly<br/>agree</a></td>
                            </tr>
                        </table>
                    </div>
                </div>
