                ...
                <div class="form-inner form-bg">
                    ...
                    <div class="container register-form">
                        <div class="form-container show-post-success closed"
                            ...
                            <p>We sent an email verification message to your email address. In the meantime, you can
                                continue to log in the site.</p>
                        ...
                        <div class="form-container hide-post-success" id="register-form-width">
                            ...
                            {{ Form::close() }}
                            <section>
                                <p class="text-center text-muted">Already have an account? <a href="{{URL::to('login')}}">Log in now</a></p>
