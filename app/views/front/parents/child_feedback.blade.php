                ...
                <div class="form-inner parent-reflect-inner">
                    ...
                    <div class="container-fluid parent-light-green">
                        <div class=" light-green-content  ">
                            ...
                            <img class=" sad-icon" src="{{ url('public/front/img/sad-icon.png')}}"/> <img
                                    class=" happy-icon" src="{{ url('public/front/img/happy-icon.png')}}"/>
                        </div>

                    </div>
                    <div class="container-fluid slider-section">
                        <div class="slider-container col-md-6 col-md-offset-3" data-empower-child-id="{{$empowerChild->id}}">

                            <div class="slider" data-answer="{{isset($feedback) ? $feedback->child_score : -1}}" >
                                <div>
