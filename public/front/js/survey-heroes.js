jQuery(function() {
	...
	$.survey = {
		...
		initSurvey: function()
		{
			...
			$('.selector').off('click').on('click', function(e) {
				...
				if (!cell.hasClass('selected'))
				{
					...
					var question = $.survey.findQuestionByNum(id);
		...
		appendQuestion: function(question)
		{
			...
			if (question.num == 1) {
				questionT = $('#questionHeroesTemplate');
			}

			if (question.num == 2) {
				questionT = $('#questionTeachTemplate');
			}
			...
			if (question.num == 1) {
				mobileT = $('#questionHeroesMobileTemplate');
			}

			if (question.num == 2) {
				mobileT = $('#questionTeachMobileTemplate');
			}
